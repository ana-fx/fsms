        ...
        <div class="flex-1 bg-gray-100">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <form method="POST" action="{{ route('customer.settings.account.update') }}" class="p-6">
                        @csrf
                        @method('PUT')
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <form method="POST" action="{{ route('customer.settings.account.password') }}" class="p-6">
                        @csrf
                        @method('PUT')
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 mb-1">Manage Delivery Addresses</h3>
                            <p class="text-sm text-gray-600">Add and manage multiple delivery addresses for easy checkout</p>
                        </div>
