            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center">
                        <a href="{{ route('supplier.dashboard') }}" class="text-gray-500 hover:text-gray-700 mr-4">
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <form method="POST" action="{{ route('supplier.settings.account.update') }}" class="p-6">
                        @csrf
                        @method('PUT')
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <form method="POST" action="{{ route('supplier.settings.account.password') }}" class="p-6">
                        @csrf
                        @method('PUT')
